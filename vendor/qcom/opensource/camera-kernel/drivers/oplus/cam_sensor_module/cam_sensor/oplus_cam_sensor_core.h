...
struct cam_sensor_i2c_reg_setting_array {
	struct cam_sensor_i2c_reg_array reg_setting[6000];
	unsigned short size;
...
struct cam_sensor_settings {
	struct cam_sensor_i2c_reg_setting_array streamon;
	...
	struct cam_sensor_i2c_reg_setting_array imx615_setting_fab2;  //Front_Main Fad2
	...
	struct cam_sensor_i2c_reg_setting_array imx882_coffeeA_setting;
	struct cam_sensor_i2c_reg_setting_array imx709_coffeeA_setting;
	struct cam_sensor_i2c_reg_setting_array hi1634q_coffeeA_setting;
	struct cam_sensor_i2c_reg_setting_array hi846_coffeeA_setting;
	struct cam_sensor_i2c_reg_setting_array s5kjn5_setting;
	struct cam_sensor_i2c_reg_setting_array sc820cs_amberT_setting;
	struct cam_sensor_i2c_reg_setting_array gc02m3_amberN_setting;
	struct cam_sensor_i2c_reg_setting_array ov50d40_milkwayS3_setting;
	struct cam_sensor_i2c_reg_setting_array gc32e2_milkwayS3_setting;
	struct cam_sensor_i2c_reg_setting_array s5kjns_alphammain_setting;
	struct cam_sensor_i2c_reg_setting_array gc08a8_alphamfront_setting;
	struct cam_sensor_i2c_reg_setting_array alphammain_unique_id_read_open_setting_0;
	struct cam_sensor_i2c_reg_setting_array alphammain_unique_id_read_open_setting_1;
	struct cam_sensor_i2c_reg_setting_array alphamfront_unique_id_read_open_setting_0;
	struct cam_sensor_i2c_reg_setting_array alphamfront_unique_id_read_open_setting_1;
	struct cam_sensor_i2c_reg_setting_array gc532hs_whoopassmain_setting;
};
...
void CheckFactory(struct cam_sensor_ctrl_t *s_ctrl);

//Prepare for unique sensorid read
