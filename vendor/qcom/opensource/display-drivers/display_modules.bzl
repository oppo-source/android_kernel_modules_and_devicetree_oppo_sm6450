...
module_entry(
      ...
      config_srcs = {
         ...
         "OPLUS_FEATURE_DISPLAY" : [
             "oplus/SM6450/oplus_display_utils.c",
             "oplus/SM6450/oplus_display_sysfs_attrs.c",
             "oplus/SM6450/oplus_display_dc_diming.c",
             "oplus/SM6450/oplus_display_ffl.c",
             "oplus/SM6450/oplus_display_device.c",
             "oplus/SM6450/oplus_display_power.c",
             "oplus/SM6450/oplus_display_effect.c",
             "oplus/SM6450/oplus_display_device_ioctl.c",
             "oplus/SM6450/oplus_display_bl.c",
             "oplus/SM6450/oplus_display_interface.c",
             "oplus/SM6450/oplus_display_pwm.c",
             "oplus/SM6450/oplus_display_parse.c",
             "oplus/SM6450/oplus_display_panel_cmd.c",
             "oplus/SM6450/oplus_display_ext.c",
             "oplus/SM6450/oplus_display_esd.c",
         ],
         "OPLUS_FEATURE_DISPLAY_ADFR" : [
             "oplus/SM6450/oplus_adfr.c",
         ],
         "OPLUS_FEATURE_DISPLAY_TEMP_COMPENSATION" : [
             "oplus/SM6450/oplus_display_temp_compensation.c",
         ],
         "OPLUS_FEATURE_DISPLAY_ONSCREENFINGERPRINT" : [
             "oplus/SM6450/oplus_onscreenfingerprint.c",
         ],
