...
const char *cmd_set_prop_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-lhbm-icon-on-gama-update0-command",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update1-command",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update2-command",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update3-command",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update4-command",
	"qcom,mdss-dsi-lhbm-icon-off-gama-update0-command",
	"qcom,mdss-dsi-lhbm-icon-off-gama-update1-command",
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-lhbm-icon-on-gama-update0-command-state",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update1-command-state",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update2-command-state",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update3-command-state",
	"qcom,mdss-dsi-lhbm-icon-on-gama-update4-command-state",
	"qcom,mdss-dsi-lhbm-icon-off-gama-update0-command-state",
	"qcom,mdss-dsi-lhbm-icon-off-gama-update1-command-state",
