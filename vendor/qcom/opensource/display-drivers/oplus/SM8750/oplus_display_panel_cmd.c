...
const char *cmd_set_prop_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-fps-switch-144Hz-command",
	"qcom,mdss-dsi-fps-switch-120Hz-command",
	"qcom,mdss-dsi-fps-switch-90Hz-command",
	"qcom,mdss-dsi-fps-switch-60Hz-command",
	"qcom,mdss-dsi-fps-switch-30Hz-command",
#ifdef OPLUS_FEATURE_DISPLAY_ADFR
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-fps-switch-144Hz-command-state",
	"qcom,mdss-dsi-fps-switch-120Hz-command-state",
	"qcom,mdss-dsi-fps-switch-90Hz-command-state",
	"qcom,mdss-dsi-fps-switch-60Hz-command-state",
	"qcom,mdss-dsi-fps-switch-30Hz-command-state",
#ifdef OPLUS_FEATURE_DISPLAY_ADFR
